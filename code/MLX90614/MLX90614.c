...
#define ACK	 0
#define	NACK 1
#define SA				0x00 //Slave address ???0x5a
#define RAM_ACCESS		0x00 //RAM access command
#define EEPROM_ACCESS	0x20 //EEPROM access command
#define RAM_TOBJ1		0x06 //To1 address in the eeprom
...
{   
	...
	temp = SMBus_ReadMemory(SA, RAM_ACCESS|MLX90614_REG_TOBJ1)*2-27315;
	//temp = SMBus_ReadMemory(SA, RAM_TOBJ1)*0.02-273.15;
	return temp;
}
